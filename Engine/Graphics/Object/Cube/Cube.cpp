...
void Cube::WriteVertexData() {
	...
	// 前面 Z+
	v[ 0] = {{ -0.5f,  0.5f,  0.5f, 1 }, { 0, 0 }, { 0, 0,  1 }};
	v[ 1] = {{  0.5f,  0.5f,  0.5f, 1 }, { 1, 0 }, { 0, 0,  1 }};
	v[ 2] = {{ -0.5f, -0.5f,  0.5f, 1 }, { 0, 1 }, { 0, 0,  1 }};
	v[ 3] = {{ -0.5f, -0.5f,  0.5f, 1 }, { 0, 1 }, { 0, 0,  1 }};
	v[ 4] = {{  0.5f,  0.5f,  0.5f, 1 }, { 1, 0 }, { 0, 0,  1 }};
	v[ 5] = {{  0.5f, -0.5f,  0.5f, 1 }, { 1, 1 }, { 0, 0,  1 }};

	// 後面 Z-
	v[ 6] = {{  0.5f,  0.5f, -0.5f, 1 }, { 0, 0 }, { 0, 0, -1 }};
	v[ 7] = {{ -0.5f,  0.5f, -0.5f, 1 }, { 1, 0 }, { 0, 0, -1 }};
	v[ 8] = {{  0.5f, -0.5f, -0.5f, 1 }, { 0, 1 }, { 0, 0, -1 }};
	v[ 9] = {{  0.5f, -0.5f, -0.5f, 1 }, { 0, 1 }, { 0, 0, -1 }};
	v[10] = {{ -0.5f,  0.5f, -0.5f, 1 }, { 1, 0 }, { 0, 0, -1 }};
	v[11] = {{ -0.5f, -0.5f, -0.5f, 1 }, { 1, 1 }, { 0, 0, -1 }};

	// 左面 X-
	v[12] = {{ -0.5f,  0.5f, -0.5f, 1 }, { 0, 0 }, { -1, 0, 0 }};
	v[13] = {{ -0.5f,  0.5f,  0.5f, 1 }, { 1, 0 }, { -1, 0, 0 }};
	v[14] = {{ -0.5f, -0.5f, -0.5f, 1 }, { 0, 1 }, { -1, 0, 0 }};
	v[15] = {{ -0.5f, -0.5f, -0.5f, 1 }, { 0, 1 }, { -1, 0, 0 }};
	v[16] = {{ -0.5f,  0.5f,  0.5f, 1 }, { 1, 0 }, { -1, 0, 0 }};
	v[17] = {{ -0.5f, -0.5f,  0.5f, 1 }, { 1, 1 }, { -1, 0, 0 }};

	// 右面 X+
	v[18] = {{  0.5f,  0.5f,  0.5f, 1 }, { 0, 0 }, {  1, 0, 0 }};
	v[19] = {{  0.5f,  0.5f, -0.5f, 1 }, { 1, 0 }, {  1, 0, 0 }};
	v[20] = {{  0.5f, -0.5f,  0.5f, 1 }, { 0, 1 }, {  1, 0, 0 }};
	v[21] = {{  0.5f, -0.5f,  0.5f, 1 }, { 0, 1 }, {  1, 0, 0 }};
	v[22] = {{  0.5f,  0.5f, -0.5f, 1 }, { 1, 0 }, {  1, 0, 0 }};
	v[23] = {{  0.5f, -0.5f, -0.5f, 1 }, { 1, 1 }, {  1, 0, 0 }};

	// 上面 Y+
	v[24] = {{ -0.5f,  0.5f, -0.5f, 1 }, { 0, 0 }, { 0,  1, 0 }};
	v[25] = {{  0.5f,  0.5f, -0.5f, 1 }, { 1, 0 }, { 0,  1, 0 }};
	v[26] = {{ -0.5f,  0.5f,  0.5f, 1 }, { 0, 1 }, { 0,  1, 0 }};
	v[27] = {{ -0.5f,  0.5f,  0.5f, 1 }, { 0, 1 }, { 0,  1, 0 }};
	v[28] = {{  0.5f,  0.5f, -0.5f, 1 }, { 1, 0 }, { 0,  1, 0 }};
	v[29] = {{  0.5f,  0.5f,  0.5f, 1 }, { 1, 1 }, { 0,  1, 0 }};

	// 下面 Y-
	v[30] = {{ -0.5f, -0.5f,  0.5f, 1 }, { 0, 0 }, { 0, -1, 0 }};
	v[31] = {{  0.5f, -0.5f,  0.5f, 1 }, { 1, 0 }, { 0, -1, 0 }};
	v[32] = {{ -0.5f, -0.5f, -0.5f, 1 }, { 0, 1 }, { 0, -1, 0 }};
	v[33] = {{ -0.5f, -0.5f, -0.5f, 1 }, { 0, 1 }, { 0, -1, 0 }};
	v[34] = {{  0.5f, -0.5f,  0.5f, 1 }, { 1, 0 }, { 0, -1, 0 }};
	v[35] = {{  0.5f, -0.5f, -0.5f, 1 }, { 1, 1 }, { 0, -1, 0 }};
